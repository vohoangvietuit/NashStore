...
class EditCategory extends Component {
  ...
  componentDidUpdate(prevProps) {
    const prevId = prevProps.category.category.id || prevProps.category.category._id;
    const currentId = this.props.category.category.id || this.props.category.category._id;
